...
export const Login = () => {
  ...
  const { userInfo, setUserInfo, apiReady } = useContext(UserContext);
  ...
  return (
    <div className="container-all">
      <div className="logo-img">
        <img className="logo" src={logo} alt="onça pintada" />
      </div>
      <div className="container-login">
        <form>
          ...
          <button
            onClick={executaLogin}
            disabled={!validarFormulario() || !apiReady}
          >
            Entrar
          </button>
          <br />
          ...
          {!apiReady && (
            <div className="wake-up-notice">
              ...
              <p>
                ⚠️ Nota: Como o projeto utiliza hospedagem gratuita, o primeiro
                acesso pode demorar até 50 segundos para o servidor acordar.
                <br />
