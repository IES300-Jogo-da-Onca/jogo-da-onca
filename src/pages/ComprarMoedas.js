...
import coinIcon6 from '../assets/icons/coin6.png';
import coinIcon7 from '../assets/icons/coin7.png';
import { validarCvv, validarnomeCartao, validarNumCartao } from '../utils/validarCompraMoedas';
        ...
        <Modal className="container-pagamento" show={showModal} onHide={() => setShowModal(false)} backdrop="static" keyboard={false}>
            ...
            <Modal.Footer>
                ...
                <button className="btn-comprar" 
                        variant="primary" onClick={() => {setMoedasUsuario(moedasUsuario + quantidade);
                        setShowModal(false)}} disabled={!validarFormulario()}>Comprar</button>
            </Modal.Footer>
        </Modal>
